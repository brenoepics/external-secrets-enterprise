...
<<<<<<< HEAD
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 1.1.2](https://img.shields.io/badge/Version-1.1.2-informational?style=flat-square)
=======
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 0.17.1-rc1](https://img.shields.io/badge/Version-0.17.1--rc1-informational?style=flat-square)
>>>>>>> upstream/main
...
| esi-pod-webhook.enabled | bool | `false` |  |
