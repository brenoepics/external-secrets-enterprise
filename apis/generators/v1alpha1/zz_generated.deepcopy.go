...
func (in *GeneratorSpec) DeepCopyInto(out *GeneratorSpec) {
	*out = *in
	...
	if in.FederationSpec != nil {
		in, out := &in.FederationSpec, &out.FederationSpec
		*out = new(FederationSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.MFASpec != nil {
	...
	if in.BasicAuthSpec != nil {
		in, out := &in.BasicAuthSpec, &out.BasicAuthSpec
		*out = new(BasicAuthSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.SSHSpec != nil {
	...
	if in.Neo4jSpec != nil {
		in, out := &in.Neo4jSpec, &out.Neo4jSpec
		*out = new(Neo4jSpec)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.OpenAISpec != nil {
		in, out := &in.OpenAISpec, &out.OpenAISpec
		*out = new(OpenAISpec)
		(*in).DeepCopyInto(*out)
	}
}
