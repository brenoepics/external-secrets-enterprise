...
generate: ## Generate code and crds
	...
	@go generate ./apis/enterprise/generators/v1alpha1/gen_generic_generator/generic_generator_impl.go
...
manifests: helm.generate ## Generate manifests from helm chart
	...
	@helm repo add spiffe https://spiffe.github.io/helm-charts-hardened && helm dependency build $(HELM_DIR)
